...
<Update label="09-09-2025" description="One Item">
 ...
 The latest Telivy macOS agent ships native builds for Apple Silicon and Intel, streamlines first-run with earlier consent prompts and a PII-first scan order, skips OneDrive cloud-only placeholders to avoid unnecessary downloads, adds richer diagnostics (API + local fallback logs), and delivers a much smaller installer for faster rollout.
