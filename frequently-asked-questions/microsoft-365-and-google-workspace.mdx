...
<AccordionGroup>
  <Accordion title="What Is The Minimum User Rights And Licensing Needed To Complete The Microsoft 365 Portion Of The Assessment?">
    To get login and security data from M365, an Azure AD P1 Business license and Global admin is required. This license allows us to retrieve and monitor login statistics like location and MFA status from Microsoft. This license comes with audit logging which enables us to monitor M365 security.
  ...
  <Accordion title="Why Does My M365 Security Not Show Up Even After Connecting My Microsoft Account?">
    Sometimes M365 data fetching takes 15 minutes to a few hours based on the number of users and the event history you have.
    ...
    To trigger a re-fetch of the data, go to Setup \> Connect Cloud and click on the "Reconnect Microsoft 365 account" button. You will be notified via email when Microsoft 365 insights are ready.
  </Accordion>
  <Accordion title="Why Do I Keep Receiving An Authorization Error When Attempting To Connect My Google Workspace?">
  ...
  <Accordion title="Why Do I Keep Receiving An Error Message Saying 'Admin_Policy_Enforced'?">
    There are two possible options:
  ...
  <Accordion title="Why Does the Maximum Possible Score Differ?">
    ...
    ![Microsoft 365 secure score breakdown](/images/microsoft-365-secure-score.png)
  </Accordion>
</AccordionGroup>