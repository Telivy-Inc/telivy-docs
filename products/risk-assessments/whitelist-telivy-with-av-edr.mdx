...
1. The status then changes to “In Progress” in the Telivy portal.
2. The controller checks in every 1 hour to check if the scan has completed. Usually, the PII scan takes a bit depending on how many files are present on the asset.
