...
<AccordionGroup>
  <Accordion title="Final Score">
    Each security section is divided into 1 or more subsections. Each subsection has a grade and a weight for the final section grade. The final grade will then be determined as follows:
  ...
  <Accordion title="Internal Vulnerability">
    ...
    | Criteria                                              | Grade |
    | ----------------------------------------------------- | ----- |
    | >10% of users have at least 1 critical vulnerability | 4     |
  </Accordion>
  ...
  <Accordion title="Dark Web Security">
    ...
    | Criteria                                                            | Grade |
    | ------------------------------------------------------------------- | ----- |
    | Dark Web findings in the last 2 years                               | D     |
  ...
  <Accordion title="Password Security">
    Password security grades will be determined as follows:
